...
public class News {
	...
	for (int i = 0; i < 10; ++i) {
	    news.add(new NewsItem("News Title" + i, "News Desc" + i, "http://www.yahoo.com", "News Category" + i, "News Author" + i));
	}
    }
	...
	return "Mashups4JSF Title";
    }
    
    @FeedDescription
    public String getDescription() {
	return "Mashups4JSF Description";
    }
    
    @FeedLink
    public String getLink() {
	return "http://www.mashups4jsf.com";
    }
}
