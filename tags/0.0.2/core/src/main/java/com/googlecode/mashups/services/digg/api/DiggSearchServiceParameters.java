...
public interface DiggSearchServiceParameters {
    ...
    final static String SEARCH_ARGS_METHOD       = "method"; // e.g.
                                                             // search.stories
    final static String SEARCH_ARGS_TYPE         = "type";  // e.g. xml, json,
                                                             // javascript,
    // search.story arguments
    final static String SEARCH_ARGS_COUNT        = "count"; // the request count for paging support
